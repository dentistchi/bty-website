...
## 현재 대기 작업 (보드와 동일) — **SPRINT 155** (TASK **1~10**)
...
| 6 | **[VERIFY] C5** 엘리트 §3 | **`[ ]`** |
| 7 | **[DOCS] C1** § 다음 작업 | **`[ ]`** |
| 8 | **[DOMAIN] C3** `arenaRunIdFromUnknown` Symbol·bigint | **`[ ]`** |
| 9 | **[TEST] C3** `POST /api/arena/lab/complete` completedOn bigint → 400 | **`[ ]`** |
...
- `docs/NEXT_BACKLOG_AUTO4.md` — **S104 TASK14·15** · **S155 → S156** (`SPRINT_PLAN` **362**)
