...
- **옷(outfits)**: `outfits/outfit_{outfitId}.png` — Professional 7종 + Fantasy·캐릭터용. `/avatars/outfits/outfit_scrub_general.png` 등. 정렬 스크립트로 동일 캔버스/앵커 맞춘 뒤 배치. (설계: `docs/spec/AVATAR_ALIGNMENT_AND_OUTFIT_SPEC.md`.)
