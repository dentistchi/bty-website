...
| 3 | **`bty-app/docs/CURRENT_TASK.md`** | 현재 구현할 기능·한 줄 지시·백로그 참조 |
...
3. bty-app/docs/CURRENT_TASK.md — 지금 구현할 기능·한 줄 지시
...
다른 Cursor에서 작업을 마치면 아래를 **반드시 갱신**하세요.

- **`docs/CURRENT_TASK.md`** — 완료한 항목 [x], 다음 "이번에 구현할 기능" 반영
