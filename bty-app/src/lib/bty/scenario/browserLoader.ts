...
export async function loadScenario(id: string, locale: "en" | "ko"): Promise<BrowserScenario> {
...
export function loadAllScenarios(locale: "en" | "ko"): Promise<BrowserScenario[]> {
