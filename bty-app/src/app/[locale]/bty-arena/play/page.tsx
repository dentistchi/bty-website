...
export default function BtyArenaPage() {
  ...
  if (!s.levelChecked) {
    return (
      <div data-testid="arena-play-loading" style={{ maxWidth: 560, margin: "0 auto", padding: 24 }}>
  ...
  if (s.requiresBeginnerPath) {
    return (
      <div data-testid="arena-play-gate-beginner" style={{ maxWidth: 560, margin: "0 auto", padding: 24 }}>
  ...
  if (!s.scenario) {
    return (
      <div data-testid="arena-play-empty-scenario" style={{ maxWidth: 560, margin: "0 auto", padding: 24 }}>
