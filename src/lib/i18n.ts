...
export type Messages = {
  ...
  uxPhase1Stub: {
    ...
    /** `/bty-arena/play` — `ArenaTopBar` (`lobbyTopBarAria`·record과 문구 분리) */
    arenaMissionPlayTopBarAria: string;
    /** `/bty-arena/play` — 좌측 시각 장면 패널 (`role="region"`) */
    arenaMissionPlaySceneRegionAria: string;
    /** `/bty-arena/play` — 우측 시나리오·선택·확정 (`lobbyCtaRegionAria`·`recordCtaRegionAria`와 분리) */
    arenaMissionPlayDecisionsRegionAria: string;
...
const ko: Messages = {
  today: {
    ...
    profileTitle: "오늘의 나",
    coreXpLabel: "Core XP",
    levelStub: "레벨과 리더십 상태는 곧 공개됩니다",
    companionName: "Dr. Chi",
    companionLine: "오늘 한 걸음이면 충분합니다.",
    situationTitle: "오늘의 선택",
  ...
  avatarOutfit: {
    ...
    outfit: "옷",
    noOutfits: "선택 가능한 옷이 없습니다.",
    save: "저장",
    saving: "저장 중",
    saveAria: "저장",
    errorLoad: "아바타 설정을 불러오지 못했습니다.",
    outfitLabels: {
      outfit_1_basic_clinic_scrubs: "기본 클리닉 스크럽",
      outfit_2_assistant_utility_uniform: "어시스턴트 유틸리티 유니폼",
      outfit_3_hygiene_scrubs: "위생 스크럽",
      outfit_4_standard_dental_coat: "표준 치과 가운",
      outfit_5_clinic_utility_uniform: "클리닉 유틸리티 유니폼",
      outfit_6_digital_dentistry_coat: "디지털 덴티스트리 코트",
      outfit_7_imaging_technician_suit: "영상기사 슈트",
      outfit_8_surgical_scrubs: "수술 스크럽",
      outfit_9_orthodontic_specialist_coat: "교정 전문 코트",
      outfit_10_pediatric_dentistry_uniform: "소아치과 유니폼",
      outfit_11_implant_surgery_armor_scrubs: "임플란트 수술 아머 스크럽",
      outfit_12_ai_diagnostic_suit: "AI 진단 슈트",
      outfit_13_research_lab_coat: "연구실 코트",
      outfit_14_master_hygienist_uniform: "마스터 위생사 유니폼",
      outfit_15_prosthetic_design_coat: "보철 디자인 코트",
      outfit_16_neurosight_clinical_suit: "뉴로사이트 클리닉 슈트",
      outfit_17_bty_arena_champion_uniform: "BTY 아레나 챔피언 유니폼",
      outfit_18_foundry_engineer_outfit: "파운드리 엔지니어 의상",
      outfit_19_master_surgeon_robe: "마스터 서전 로브",
      outfit_20_digital_dentistry_elite_coat: "디지털 덴티스트리 엘리트 코트",
  ...
  uxPhase1Stub: {
    ...
    arenaMissionPlayTopBarAria: "미션 플레이 상단 — 단계·진행·코드네임",
    arenaMissionPlaySceneRegionAria: "미션 플레이 — 상황 장면",
...
const en: Messages = {
  today: {
    ...
    profileTitle: "Today's me",
    coreXpLabel: "Core XP",
    levelStub: "Level and leadership status — coming soon",
    companionName: "Dr. Chi",
    companionLine: "One honest step today is enough.",
    situationTitle: "Today's choice",
    situationEmpty: "No open action right now.",
    beginCta: "Begin",
    pointsTitle: "Today's points",
    pointsLabel: "XP earned",
  ...
  avatarOutfit: {
    ...
    outfitLabels: {
      outfit_1_basic_clinic_scrubs: "Basic Clinic Scrubs",
      outfit_2_assistant_utility_uniform: "Assistant Utility Uniform",
      outfit_3_hygiene_scrubs: "Hygiene Scrubs",
      outfit_4_standard_dental_coat: "Standard Dental Coat",
      outfit_5_clinic_utility_uniform: "Clinic Utility Uniform",
      outfit_6_digital_dentistry_coat: "Digital Dentistry Coat",
      outfit_7_imaging_technician_suit: "Imaging Technician Suit",
      outfit_8_surgical_scrubs: "Surgical Scrubs",
      outfit_9_orthodontic_specialist_coat: "Orthodontic Specialist Coat",
      outfit_10_pediatric_dentistry_uniform: "Pediatric Dentistry Uniform",
      outfit_11_implant_surgery_armor_scrubs: "Implant Surgery Armor Scrubs",
      outfit_12_ai_diagnostic_suit: "AI Diagnostic Suit",
      outfit_13_research_lab_coat: "Research Lab Coat",
      outfit_14_master_hygienist_uniform: "Master Hygienist Uniform",
      outfit_15_prosthetic_design_coat: "Prosthetic Design Coat",
      outfit_16_neurosight_clinical_suit: "Neurosight Clinical Suit",
      outfit_17_bty_arena_champion_uniform: "BTY Arena Champion Uniform",
      outfit_18_foundry_engineer_outfit: "Foundry Engineer Outfit",
      outfit_19_master_surgeon_robe: "Master Surgeon Robe",
      outfit_20_digital_dentistry_elite_coat: "Digital Dentistry Elite Coat",
  ...
  uxPhase1Stub: {
    ...
    arenaMissionPlayTopBarAria: "Mission play header — stage, progress, codename",
    arenaMissionPlaySceneRegionAria: "Mission play — situation scene",
    arenaMissionPlayDecisionsRegionAria:
