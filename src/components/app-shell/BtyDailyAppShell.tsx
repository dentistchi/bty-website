...
const COPY: Record<Locale, Copy> = {
  en: {
    ...
    arena: { title: "Practice with others.", tag: "Relationship with Others", body: "Scenarios and actions." },
    foundry: { title: "Build with the world.", tag: "Relationship with the World", body: "Learning and craft." },
  ...
  ko: {
    ...
    arena: { title: "타인과 연습하기.", tag: "타인과의 관계", body: "시나리오와 행동." },
    foundry: { title: "세계와 함께 짓기.", tag: "세계와의 관계", body: "배움과 만듦." },
