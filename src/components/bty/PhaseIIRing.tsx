...
export function PhaseIIRing() {
  return (
    <div
      className="inline-flex items-center justify-center rounded-full border-2 bg-transparent text-[10px] font-semibold uppercase tracking-wider text-[var(--foundry-purple-dark,#4a3d6d)]"
      style={{
        width: 40,
        height: 40,
