 ...
 * bty-website 앱에는 Arena API가 없어 PATCH가 404됩니다.
 * 전체 테스트는 btytrainingcenter/bty-app (cd ../bty-app && npm run dev)에서 /ko/bty/test-avatar 로 실행하세요.
 */
export default function TestAvatarPage() {
  ...
  return (
    <div style={{ maxWidth: 640, margin: "0 auto", padding: 24 }}>
      <Nav locale="ko" pathname="/bty/test-avatar" />
